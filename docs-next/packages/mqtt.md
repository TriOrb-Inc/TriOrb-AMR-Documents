...
| `/ROS_PREFIX/vslam/map_load_queuing_time_estimated` | `MQTT_PREFIX/vslam/map_load_queuing_time_estimated` | `std_msgs/msg/Float32` | `1` |
| `/ROS_PREFIX/vslam/map_skip_loading_request` | `MQTT_PREFIX/vslam/map_skip_loading_request` | `std_msgs/msg/String` | `1` |
...
| `MQTT_PREFIX/run_slam/set/save_map_file_path` | `/ROS_PREFIX/run_slam/set/save_map_file_path` | `std_msgs/msg/String` | `2` |
...
| `MQTT_PREFIX/triorb/error/add` | `/ROS_PREFIX/triorb/error/add` | `std_msgs/msg/UInt16` | `2` |
...
| ROS 2 topic | MQTT topic | ROS type | MQTT QoS |
|---|---|---|---|
| `/ROS_PREFIX/drive/max_vel` | `GROUP_NAME/collab/max_vel` | `triorb_drive_interface/msg/RobotParams` | `1` |
| `/ROS_PREFIX/drive/result` | `GROUP_NAME/drive/result` | `triorb_drive_interface/msg/TriorbRunResult` | `1` |
| `/ROS_PREFIX/lifter/result` | `GROUP_NAME/collab/lifter/result` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/collab/bind/set_entry` | `GROUP_NAME/collab/bind/set_entry` | `triorb_collaboration_interface/msg/ParentBind` | `1` |
| `/ROS_PREFIX/collab/bind/info` | `GROUP_NAME/collab/bind/info` | `triorb_collaboration_interface/msg/ParentBind` | `1` |
| `/ROS_PREFIX/collab/wakeup` | `GROUP_NAME/collab/wakeup` | `std_msgs/msg/Empty` | `1` |
| `/ROS_PREFIX/collab/sleep` | `GROUP_NAME/collab/sleep` | `std_msgs/msg/Empty` | `1` |
| `/ROS_PREFIX/collab/run_vel` | `GROUP_NAME/collab/run_vel` | `triorb_drive_interface/msg/TriorbRunVel3Stamped` | `0` |
| `/ROS_PREFIX/collab/run_lifter` | `GROUP_NAME/collab/run_lifter` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/collab/robot_pose` | `GROUP_NAME/collab/robot_pose` | `triorb_drive_interface/msg/TriorbPos3Stamped` | `0` |
| `/ROS_PREFIX/collab/robot/status` | `GROUP_NAME/collab/robot/status` | `triorb_static_interface/msg/RobotStatus` | `1` |
| `/ROS_PREFIX/collab/set_life_time` | `GROUP_NAME/collab/set_life_time` | `std_msgs/msg/UInt16` | `1` |
| `/ROS_PREFIX/collab/save_waypoint_hash` | `GROUP_NAME/collab/save_waypoint_hash` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/collab/run_slam/map_file_path` | `GROUP_NAME/collab/run_slam/map_file_path` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/collab/run_slam/map_file_changed` | `GROUP_NAME/collab/run_slam/map_file_changed` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/collab/run_slam/status` | `GROUP_NAME/collab/run_slam/status` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/collab/drive/stop` | `GROUP_NAME/collab/drive/stop` | `std_msgs/msg/Empty` | `1` |
| `/ROS_PREFIX/collab/drive/pause` | `GROUP_NAME/collab/drive/pause` | `std_msgs/msg/Empty` | `1` |
| `/ROS_PREFIX/collab/drive/restart` | `GROUP_NAME/collab/drive/restart` | `std_msgs/msg/Empty` | `1` |
| `/ROS_PREFIX/collab/drive/set_pos` | `GROUP_NAME/collab/drive/set_pos` | `triorb_drive_interface/msg/TriorbSetPos3` | `1` |
| `/ROS_PREFIX/collab/drive/result` | `GROUP_NAME/collab/drive/result` | `triorb_drive_interface/msg/TriorbRunResultStamped` | `1` |
| `/ROS_PREFIX/collab/drive/finish` | `GROUP_NAME/collab/drive/finish` | `std_msgs/msg/Bool` | `1` |
| `/ROS_PREFIX/collab/request/set_pos` | `GROUP_NAME/collab/request/set_pos` | `triorb_drive_interface/msg/TriorbSetPos3` | `1` |
| `/ROS_PREFIX/collab/navigation_policy` | `GROUP_NAME/collab/navigation_policy` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/collab/drive/init_path_follow` | `GROUP_NAME/collab/drive/init_path_follow` | `std_msgs/msg/Empty` | `1` |
| `/ROS_PREFIX/drive/set_positioning_timeout_mode` | `GROUP_NAME/collab/drive/set_positioning_timeout_mode` | `triorb_drive_interface/msg/TriorbPositioningTimeoutMode` | `1` |
| `/ROS_PREFIX/drive/set_lost_timeout_sec` | `GROUP_NAME/collab/set_lost_timeout_sec` | `std_msgs/msg/Float32` | `1` |
| `/ROS_PREFIX/collab/emergency_state` | `GROUP_NAME/collab/emergency_state` | `std_msgs/msg/Bool` | `1` |
| `/ROS_PREFIX/collab/aux/event` | `GROUP_NAME/collab/aux/event` | `std_msgs/msg/String` | `1` |
| `/ROS_PREFIX/sls/change_to_sls_off` | `GROUP_NAME/sls/change_to_sls_off` | `std_msgs/msg/Bool` | `1` |
| `/ROS_PREFIX/collab/drive/estop` | `GROUP_NAME/collab/drive/estop` | `std_msgs/msg/Empty` | `1` |
| `/ROS_PREFIX/triorb/error/reset` | `GROUP_NAME/triorb/error/reset` | `std_msgs/msg/UInt8` | `1` |
| `/ROS_PREFIX/collab/alive` | `GROUP_NAME/collab/alive` | `std_msgs/msg/Header` | `1` |
| `/ROS_PREFIX/triorb/error/str/log` | `GROUP_NAME/triorb/error/str/log` | `std_msgs/msg/String` | `0` |
| `/ROS_PREFIX/run_slam/set/change_map_file_path` | `GROUP_NAME/run_slam/set/change_map_file_path` | `std_msgs/msg/String` | `2` |
### 協調 global bridge: MQTT to ROS 2

| MQTT topic | ROS 2 topic | ROS type | MQTT QoS |
|---|---|---|---|
| `GROUP_NAME/drive/result` | `/ROS_PREFIX/bc/drive/result` | `triorb_drive_interface/msg/TriorbRunResult` | `1` |
| `GROUP_NAME/collab/joy` | `/ROS_PREFIX/bc/collab/joy` | `sensor_msgs/msg/Joy` | `0` |
| `GROUP_NAME/collab/bind/info` | `/ROS_PREFIX/bc/collab/bind/info` | `triorb_collaboration_interface/msg/ParentBind` | `1` |
| `GROUP_NAME/collab/bind/set_entry` | `/ROS_PREFIX/bc/collab/bind/set` | `triorb_collaboration_interface/msg/ParentBind` | `1` |
| `GROUP_NAME/collab/max_vel` | `/ROS_PREFIX/bc/collab/max_vel` | `triorb_drive_interface/msg/RobotParams` | `1` |
| `GROUP_NAME/collab/wakeup` | `/ROS_PREFIX/drive/wakeup` | `std_msgs/msg/Empty` | `1` |
| `GROUP_NAME/collab/sleep` | `/ROS_PREFIX/drive/sleep` | `std_msgs/msg/Empty` | `1` |
| `GROUP_NAME/collab/run_vel` | `/ROS_PREFIX/bc/collab/run_vel` | `triorb_drive_interface/msg/TriorbRunVel3Stamped` | `0` |
| `GROUP_NAME/collab/run_lifter` | `/ROS_PREFIX/bc/collab/run_lifter` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/robot_pose` | `/ROS_PREFIX/bc/collab/robot_pose` | `triorb_drive_interface/msg/TriorbPos3Stamped` | `0` |
| `GROUP_NAME/collab/robot/status` | `/ROS_PREFIX/bc/collab/robot/status` | `triorb_static_interface/msg/RobotStatus` | `1` |
| `GROUP_NAME/collab/set_life_time` | `/ROS_PREFIX/bc/collab/set_life_time` | `std_msgs/msg/UInt16` | `1` |
| `GROUP_NAME/collab/save_waypoint_hash` | `/ROS_PREFIX/bc/collab/save_waypoint_hash` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/run_slam/map_file_path` | `/ROS_PREFIX/bc/collab/run_slam/map_file_path` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/run_slam/map_file_changed` | `/ROS_PREFIX/bc/collab/run_slam/map_file_changed` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/run_slam/status` | `/ROS_PREFIX/bc/collab/run_slam/status` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/last_will` | `/ROS_PREFIX/bc/collab/last_will` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/drive/stop` | `/ROS_PREFIX/bc/collab/drive/stop` | `std_msgs/msg/Empty` | `1` |
| `GROUP_NAME/collab/drive/pause` | `/ROS_PREFIX/bc/collab/drive/pause` | `std_msgs/msg/Empty` | `1` |
| `GROUP_NAME/collab/drive/restart` | `/ROS_PREFIX/bc/collab/drive/restart` | `std_msgs/msg/Empty` | `1` |
| `GROUP_NAME/collab/drive/set_pos` | `/ROS_PREFIX/bc/collab/drive/set_pos` | `triorb_drive_interface/msg/TriorbSetPos3` | `1` |
| `GROUP_NAME/collab/drive/result` | `/ROS_PREFIX/bc/collab/drive/result` | `triorb_drive_interface/msg/TriorbRunResultStamped` | `1` |
| `GROUP_NAME/collab/drive/finish` | `/ROS_PREFIX/bc/collab/drive/finish` | `std_msgs/msg/Bool` | `1` |
| `GROUP_NAME/collab/lifter/result` | `/ROS_PREFIX/bc/collab/lifter/result` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/request/set_pos` | `/ROS_PREFIX/bc/collab/request/set_pos` | `triorb_drive_interface/msg/TriorbSetPos3` | `1` |
| `GROUP_NAME/collab/navigation_policy` | `/ROS_PREFIX/bc/collab/navigation_policy` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/collab/drive/init_path_follow` | `/ROS_PREFIX/bc/collab/drive/init_path_follow` | `std_msgs/msg/Empty` | `1` |
| `GROUP_NAME/collab/drive/set_positioning_timeout_mode` | `/ROS_PREFIX/bc/collab/drive/set_positioning_timeout_mode` | `triorb_drive_interface/msg/TriorbPositioningTimeoutMode` | `1` |
| `GROUP_NAME/collab/set_lost_timeout_sec` | `/ROS_PREFIX/bc/collab/set_lost_timeout_sec` | `std_msgs/msg/Float32` | `1` |
| `GROUP_NAME/collab/emergency_state` | `/ROS_PREFIX/bc/collab/emergency_state` | `std_msgs/msg/Bool` | `1` |
| `GROUP_NAME/collab/aux/event` | `/ROS_PREFIX/bc/collab/aux/event` | `std_msgs/msg/String` | `1` |
| `GROUP_NAME/sls/change_to_sls_off` | `/ROS_PREFIX/bc/sls/change_to_sls_off` | `std_msgs/msg/Bool` | `1` |
| `GROUP_NAME/collab/drive/estop` | `/ROS_PREFIX/bc/collab/drive/estop` | `std_msgs/msg/Empty` | `1` |
| `GROUP_NAME/triorb/error/reset` | `/ROS_PREFIX/bc/triorb/error/reset` | `std_msgs/msg/UInt8` | `1` |
| `GROUP_NAME/collab/alive` | `/ROS_PREFIX/bc/collab/alive` | `std_msgs/msg/Header` | `1` |
| `GROUP_NAME/triorb/error/str/log` | `/ROS_PREFIX/bc/triorb/error/str/log` | `std_msgs/msg/String` | `0` |
| `GROUP_NAME/run_slam/set/change_map_file_path` | `/ROS_PREFIX/run_slam/bc/set/change_map_file_path` | `std_msgs/msg/String` | `2` |
