...
- The documentation site published as the `TriOrb BASE Developer Guide`
- The `TriOrb-AMR-Documents` repository and related GitHub pages introduced by us
- Cases where a future ChatGPT App or other support channel provided by us directs users to this site or GitHub pages
- API specifications, samples, manuals, change logs, external links, and related materials published through the above
...
- Use of robots, ECUs, ROS 2 nodes, Web APIs, and related software requires separate hardware, network setup, operational procedures, and safety management
...
- Any act that infringes the rights, interests, reputation, or credibility of us or any third party
- Any act that imposes excessive load on this site, GitHub repositories, hosting infrastructure, or related services
- Unauthorized access, vulnerability probing, bypass of authentication, abusive scraping, malware transmission, or any other security intrusion
- Unauthorized acquisition, use, or disclosure of information, repositories, credentials, or customer environment data that we treat as non-public
- Circumvention of robot safety mechanisms, control restrictions, or operational safeguards in a manner that causes dangerous behavior
...
Where separate license notices are attached to source files, documentation source, or other deliverables in this repository, those notices take precedence. At present, an Apache License 2.0 file exists at the root of this repository, and that license applies within its scope.

However, separate conditions may apply to the following:

- The `TriOrb` and `TriOrb BASE` names, our logos, and other trademark-related elements
...
Unless otherwise agreed, proposals, fixes, or contributions intentionally submitted for inclusion in this repository will be handled under the license terms applicable to this repository and under GitHub's terms.

For inquiries, requests, error reports, or improvement proposals submitted through future non-public channels such as a ChatGPT App provided by us, we may remove directly identifying information where reasonably possible and then use the content in anonymized or aggregated form to improve TriOrb products, related software, documentation, and support quality.
...
In particular, the use of robot control functions, path generation, sensor processing, ECU communications, Web API operations, or sample code may result in physical damage, service interruption, malfunction, or harm to third parties. You are solely responsible for your own verification, monitoring, safety checks, and backup measures at your own cost and risk.
...
For general API questions and bug reports, users may use GitHub Issues, GitHub Discussions, or future channels such as a ChatGPT App provided by us. However, if a matter cannot be resolved through a ChatGPT App or similar channel, we may direct the user to GitHub Issues or GitHub Discussions.

GitHub Issues and GitHub Discussions are public channels, and poster IDs are publicly visible, so anonymity is limited. If your inquiry contains personal information or confidential information, or if you prefer a non-public contact route, do not use a public post and instead contact `info@triorb.co.jp`.
