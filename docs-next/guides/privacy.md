...
- When you contact us or the repository maintainers through GitHub Issues, Discussions, Pull Requests, or similar channels
- When you contact us through a future non-public channel such as a ChatGPT App provided by us
- When you move to an external destination linked from this site, to the extent that we provide that route
...
- GitHub account name, display name, and profile information
- Content of Issues, Discussions, Pull Requests, comments, attachments, and other submissions
- Questions, requests, error reports, ratings, attachments, and other content entered into future channels such as a ChatGPT App provided by us
- Contact details, affiliation, environment information, and other information you voluntarily provide when making an inquiry

### 3.2 Information Collected Through Use of This Site

- IP address, timestamps, accessed URLs, referrers, browser type, operating system, and similar access log information
- Technical information normally collected by GitHub, GitHub Pages, and other hosting providers
- Preference information stored in browser local storage or similar browser-side storage for display settings and related functions

This site is structured as a static documentation site using MkDocs and Material for MkDocs, and browser-side storage may be used to retain display settings and similar preferences.

### 3.3 Information Potentially Collected Through External Services
...
- To provide this site, API specifications, sample code, change logs, and other public information
- To respond to inquiries, bug reports, proposals, and submitted content
- To improve documentation quality, site structure, maintenance, and incident response
- To analyze inquiry trends and improvement requests in order to improve TriOrb products, related software, documentation, and support quality
- To prevent, investigate, and respond to misuse, security incidents, rights violations, or operational issues
- To comply with legal obligations, protect rights, or respond to disputes

For content submitted through future non-public channels such as a ChatGPT App provided by us, we may remove directly identifying information where necessary and then use the content in anonymized or aggregated form to improve TriOrb products, related software, documentation, and support quality.
